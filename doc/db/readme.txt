...
docker run --name db -e MYSQL_ROOT_PASSWORD=a1b2c3d4 -p 3306:3306 mariadb:5.5
...
~/git/ace/ace-docker/src/main/images/ace-app/run.sh ~/git/ace/ace-assembly/src/main/config $HOME ~/git/ace/ace-docker/src/main/images/ace-app ~/git/ace/ace-docker/src/main/images/ace-app

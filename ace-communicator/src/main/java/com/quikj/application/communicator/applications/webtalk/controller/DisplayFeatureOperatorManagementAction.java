/*
 * DisplayFeatureOperatorManagementAction.java
 *
 */
 ...
 * @author bhm
 */
public class DisplayFeatureOperatorManagementAction extends Action {

	public DisplayFeatureOperatorManagementAction() {
	}

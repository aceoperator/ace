...
<tiles:insert page="/aceapp/jsp/layout.jsp" flush="true">
 <tiles:put name="title" value="Operator Feature Administration"/>
 ...
 <tiles:put name="body" value="/aceapp/jsp/applications/webtalk/feature_operator_management_body.jsp"/>
</tiles:insert>
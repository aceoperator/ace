...
<tiles:insert page="/aceapp/jsp/layout.jsp" flush="true">
 <tiles:put name="title" value="Canned Message Search Results"/>
 ...
 <tiles:put name="body" value="/aceapp/jsp/applications/webtalk/canned_message_search_result_body.jsp"/>
</tiles:insert>
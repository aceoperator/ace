...
<tiles:insert page="/aceapp/jsp/layout.jsp" flush="true">
 <tiles:put name="title" value="Remove Customer Wizard"/>
 ...
 <tiles:put name="body" value="/aceapp/jsp/applications/webtalk/drop_customer/drop_customer_body_finished.jsp"/>
</tiles:insert>
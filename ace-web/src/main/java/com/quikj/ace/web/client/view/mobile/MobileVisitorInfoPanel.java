 ...
 * 
 */
public class MobileVisitorInfoPanel extends LayoutPanel implements
		VisitorInfoPanel {
	...
	public MobileVisitorInfoPanel() {
		...
		caption = new HTML(captionText + "<p>");

 ...
 *
 */
public interface ChromeLargeTheme extends ClientBundle {
	
	public static final ChromeLargeTheme INSTANCE = GWT.create(ChromeLargeTheme.class);

	@Source("com/quikj/ace/web/client/theme/ChromeLarge.css")
	public ChromeLarge chromeLarge();
